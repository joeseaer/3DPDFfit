/*************************************************************************************
*
* class PDF3DGPUCalculator -- 3D real-space pair distribution function calculator
*
*************************************************************************************/

#ifndef PDF3DGPUCALCULATOR_HPP_INCLUDED
#define PDF3DGPUCALCULATOR_HPP_INCLUDED
...
class PDF3DGPUCalculator : public PDFCalculator
{
public:
    // constructor
    PDF3DGPUCalculator();
...
protected:
    ...
    virtual void finishValue() override;
...
private:
    ...
    std::vector<PDF3DGpuPair> mpendinggpupairs;
...
#endif  // PDF3DGPUCALCULATOR_HPP_INCLUDED
